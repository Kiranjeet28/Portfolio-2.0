    ...
    try {
      await emailjs.send(
        ...
        import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID,
        {
          ...
          to_name: 'Kiranjeet Kour',
          to_email: 'kiranjeetkour144@gmail.com',
    ...
    <section className="c-space my-20" id="contact">
      ...
      <div className="relative min-h-screen flex items-center justify-center flex-col py-10">
        ...
        <NeonGradientCard
          borderSize={1.5}
          borderRadius={24}
          className="w-full max-w-xl relative z-10 shadow-2xl transition-all duration-300 hover:scale-[1.01] hover:border-purple-500/20"
        >
          <div className="sm:p-10 p-6 rounded-[22.5px] bg-black-100/90 backdrop-blur-md">

            <h3 className="text-3xl font-bold text-white bg-gradient-to-r from-purple-400 to-indigo-400 bg-clip-text text-transparent">
              Let's Connect
            </h3>
