...
export function MinorProject() {
  const testimonials = [
    {
      quote: "This is a clone project that replicates many features of YouTube while adding extra functionality. The platform includes an Interested Section that displays channels you are interested in. It also offers features similar to YouTube, such as watch history, video categories, comments, likes, and more.",
      name: "Youtube Clone",
      designation: "React.js, Node.js, TypeScript, TailwindCSS",
      src: "https://thumbs.dreamstime.com/b/youtube-play-button-vector-illustration-cartoon-youtube-play-button-shadow-background-vector-illustration-cartoon-262961349.jpg",
