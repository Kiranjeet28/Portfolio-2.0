      ...
      <div className="grid  grid-cols-1 mt-12 gap-5 w-full">
        <div className="flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl shadow-black-200">
          ...
          <div className="flex items-center justify-between flex-wrap gap-5">
            ...
            <a
              className="flex mt-24 items-center gap-2  cursor-pointer absolute right-10 z-50 text-white-600"
              href={currentProject.href}
              target="_blank"
              rel="noreferrer">
              <p>Check Live Site</p>
              <img src="/assets/arrow-up-scaled.png" alt="arrow" className="w-3 h-3" />
            </a>
          </div>
